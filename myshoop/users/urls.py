...
from .views import (CustomSignupView, CustomLoginView, CustomMailConform, YouShoppingCart,
    clear_shopping_cart, remove_product_from_shc, change_product_amount_in_sch,
    Finalize_Order, Person_Page)

urlpatterns =[
    path('signup/', CustomSignupView.as_view(), name='account_signup'),
    path('login/', CustomLoginView.as_view(), name='account_login'),
    re_path(r'^accounts/confirm-email/(?P<key>[-:\w]+)/$', CustomMailConform.as_view(), name='account_confirm_email'),
